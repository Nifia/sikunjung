...
if ($koneksi) {
    ...
    $updateAccept = "UPDATE ttamu SET status_kunjungan='Accepted', keterangan_rejected='' WHERE id='$id'";
    $Accept = mysqli_query($koneksi, $updateAccept);
    ...
    if ($Accept) {
        ...
        $pesan .= "<p><strong>Status : </strong> DITERIMA </p>" .
            "<p> Terima kasih atas pengajuan kunjungannya.</p>" .
            "<br>" .
            "<p>Hormat kami,</p>" .
